...
(function() {
  var BLANK, BOARDSIZE, GROUPHEIGHT, GROUPWIDTH, SudokuGrid, init, randomInt, solver, ui,
  ...
  init = function() {
    ...
    $('#demo').click(function() {
      ...
      ui.clearTable();
      grid = new SudokuGrid();
      for (i = _i = 1; 1 <= BOARDSIZE ? _i <= BOARDSIZE : _i >= BOARDSIZE; i = 1 <= BOARDSIZE ? ++_i : --_i) {
        grid.grid[randomInt(0, BOARDSIZE - 1)][randomInt(0, BOARDSIZE - 1)] = i;
      }
      ui.setTable(grid);
      $('#demo').removeClass('info');
      return $('#solve').removeClass('info').addClass('primary');
    });
